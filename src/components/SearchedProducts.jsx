          ...
          {displayProducts.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {/* View Details Button */}
                <button className="mt-3 w-full bg-black text-white py-2 px-4 rounded-md hover:bg-gray-800 transition-colors duration-200 text-sm font-medium cursor-pointer">
                  Add To Cart
                </button>
              </div>
            </div>
