...
const BottomNav = ({ onSearchOpen }) => {
  ...
  return (
    <div className="fixed bottom-5 left-0 w-full bg-transparent flex justify-center gap-50 py-5 z-10">
      {/* Home */}
      ...
      >
        <div className="w-11 h-11 bg-white rounded-full flex items-center justify-center shadow-md transition-transform duration-300 hover:scale-160 transform scale-150">
          {isSearchOpen ? (
            // Cross Icon
            <svg
              width="24"
            ...
            >
              <path
                ...
                stroke={activeIcon === 'search' ? 'black' : 'black'}
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
            ...
            >
              <path
                ...
                stroke={activeIcon === 'search' ? 'none' : 'black'}
                fill={activeIcon === 'search' ? 'black' : 'none'}
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
